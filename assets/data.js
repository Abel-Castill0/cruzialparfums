...
const IMG_MAP = {
  ...
  "khamrah-clasico": { bottle: "img/perfumes/transparent/LATTAFA - KHAMRAH CLASICO.webp", set: "img/perfumes/transparent/LATTAFA - KHAMRAH CLASICO (2).webp" },
  "khamrah-qahwa": { bottle: "img/perfumes/transparent/LATTAFA - KHAMRAH QAHWA.webp", set: "img/perfumes/transparent/LATTAFA - KHAMRAH QAHWA (2).webp" },
  "khamrah-dukhan": { bottle: "img/perfumes/transparent/LATTAFA - KHAMRAH DUKHAN.webp", set: "img/perfumes/transparent/LATTAFA - KHAMRAH DUKHAN (2).webp" },
  "khamrah-waha": { bottle: "img/perfumes/transparent/Khamrah Waha.webp", set: "img/perfumes/transparent/Khamrah Waha (2).webp" },

  // ÁRABE - Lattafa otros
  "mashrabya": { bottle: "img/perfumes/transparent/Mashrabya.webp", set: "img/perfumes/transparent/Mashrabya (2).webp" },
  "asad-elixir": { bottle: "img/perfumes/transparent/Asad Elixir.webp", set: "img/perfumes/transparent/Asad Elixir (2).webp" },
  "asad-clasico": { bottle: "img/perfumes/transparent/LATTAFA - ASAD CLASICO.webp", set: "img/perfumes/transparent/LATTAFA - ASAD CLASICO (2).webp" },
  "asad-bourbon": { bottle: "img/perfumes/transparent/LATTAFA - ASAD BOURBON.webp", set: "img/perfumes/transparent/LATTAFA - ASAD BOURBON (2).webp" },
  "zanzibar-limited-e": { bottle: "img/perfumes/transparent/Zanzibar Limited Edition.webp", set: "img/perfumes/transparent/Zanzibar Limited Edition (2).webp" },
  "yara-pink": { bottle: "img/perfumes/LATTAFA - YARA PINK.png", set: "img/perfumes/LATTAFA - YARA PINK (2).png" },
  "yara-candy": { bottle: "img/perfumes/transparent/Yara Candy.webp", set: "img/perfumes/transparent/Yara Candy (2).webp" },
  "yara-elixir": { bottle: "img/perfumes/transparent/LATTAFA - YARA ELIXIR.webp", set: "img/perfumes/transparent/LATTAFA - YARA ELIXIR (2).webp" },
  "sublime": { bottle: "img/perfumes/transparent/LATTAFA - SUBLIME.webp", set: "img/perfumes/transparent/LATTAFA - SUBLIME (2).webp" },
  "oud-for-glory": { bottle: "img/perfumes/transparent/Oud For Glory.webp", set: "img/perfumes/transparent/Oud For Glory (2).webp" },
  "honor-and-glory": { bottle: "img/perfumes/transparent/LATTAFA - HONOR AND GLORY.webp", set: "img/perfumes/transparent/LATTAFA - HONOR AND GLORY (2).webp" },
  "eclaire": { bottle: "img/perfumes/LATTAFA - ECLAIRE.png", set: "img/perfumes/LATTAFA - ECLAIRE (2).png" },
  "eclaire-banoffi": { bottle: "img/perfumes/transparent/Lattafa Eclaire Banoffi.webp", set: "img/perfumes/transparent/Lattafa Eclaire Banoffi (2).webp" },
  "eclaire-pistache": { bottle: "img/perfumes/transparent/Lattafa Eclaire Pistache.webp", set: "img/perfumes/transparent/Lattafa Eclaire Pistache (2).webp" },
  ...
  "fakhar-black": { bottle: "img/perfumes/transparent/Lattafa Fakhar Black.webp", set: "img/perfumes/transparent/Lattafa Fakhar Black (2).webp" },
  "qaed-al-fursan": { bottle: "img/perfumes/transparent/Lattafa Qaed Al Fursan.webp", set: "img/perfumes/transparent/Lattafa Qaed Al Fursan (2).webp" },
  "red-intensely": { bottle: "img/perfumes/transparent/Lattafa Red Intensely.webp", set: "img/perfumes/transparent/Lattafa Red Intensely (2).webp" },

  // ÁRABE - Afnan
  "mandarin-sky": { bottle: "img/perfumes/transparent/ARMAF - MANDARIN SKY.webp", set: "img/perfumes/transparent/ARMAF - MANDARIN SKY (2).webp" },
  "m-sky-elixir": { bottle: "img/perfumes/transparent/Mandarin Sky Elixir.webp", set: "img/perfumes/transparent/Mandarin Sky Elixir (2).webp" },
  "m-sky-vintage": { bottle: "img/perfumes/transparent/Mandarin Sky Vintage.webp", set: "img/perfumes/transparent/Mandarin Sky Vintage (2).webp" },
  "9pm": { bottle: "img/perfumes/transparent/AFNAN - 9PM.webp", set: "img/perfumes/transparent/AFNAN - 9PM (2).webp" },
  "9pm-rebel": { bottle: "img/perfumes/transparent/9 PM Rebel.webp", set: "img/perfumes/transparent/9 PM Rebel (2).webp" },
  "9pm-elixir": { bottle: "img/perfumes/transparent/AFNAN - 9PM ELIXIR.webp", set: "img/perfumes/transparent/AFNAN - 9PM ELIXIR (2).webp" },
  "9pm-night-out": { bottle: "img/perfumes/transparent/AFNAN - 9PM NIGHT OUT.webp", set: "img/perfumes/transparent/AFNAN - 9PM NIGHT OUT (2).webp" },
  "9am": { bottle: "img/perfumes/transparent/Afnan 9 AM.webp", set: "img/perfumes/transparent/Afnan 9 AM (2).webp" },
  "9am-dive": { bottle: "img/perfumes/transparent/AFNAN - 9AM DIVE.webp", set: "img/perfumes/transparent/AFNAN - 9AM DIVE (2).webp" },
  "supremacy-colle": { bottle: "img/perfumes/transparent/Afnan Supremacy Collection.webp", set: "img/perfumes/transparent/Afnan Supremacy Collection (2).webp" },
  "supremacy-noi": { bottle: "img/perfumes/transparent/Afnan Supremacy NOIR.webp", set: "img/perfumes/transparent/Afnan Supremacy NOIR (2).webp" },

  // ÁRABE - Lattafa Odyssey
  "odyssey-aqua": { bottle: "img/perfumes/transparent/ARMAF - ODYSSEY AQUA.webp", set: "img/perfumes/transparent/ARMAF - ODYSSEY AQUA (2).webp" },
  "odyssey-homme": { bottle: "img/perfumes/transparent/Lattafa Odyssey Homme.webp", set: "img/perfumes/transparent/Lattafa Odyssey Homme (2).webp" },
  "homme-white": { bottle: "img/perfumes/transparent/Lattafa Homme White.webp", set: "img/perfumes/transparent/Lattafa Homme White (2).webp" },
  "odyssey-spectra": { bottle: "img/perfumes/transparent/Lattafa Odyssey Spectra.webp", set: "img/perfumes/transparent/Lattafa Odyssey Spectra (2).webp" },
  "odyssey-mega": { bottle: "img/perfumes/transparent/Lattafa Odyssey Mega.webp", set: "img/perfumes/transparent/Lattafa Odyssey Mega (2).webp" },
  "odyssey-limoni": { bottle: "img/perfumes/transparent/Lattafa Odyssey Limoni.webp", set: "img/perfumes/transparent/Lattafa Odyssey Limoni (2).webp" },
  "odyssey-artisto": { bottle: "img/perfumes/transparent/Lattafa Odyssey Artisto.webp", set: "img/perfumes/transparent/Lattafa Odyssey Artisto (2).webp" },

  // ÁRABE - Lattafa Mayar
  "mayar": { bottle: "img/perfumes/Lattafa Mayar.png", set: "img/perfumes/Lattafa Mayar (2).png" },
  "mayar-cherry-i": { bottle: "img/perfumes/transparent/Lattafa Mayar Cherry Intense.webp", set: "img/perfumes/transparent/Lattafa Mayar Cherry Intense (2).webp" },

  // ÁRABE - Rasasi Hawas
  "hawas-exotic": { bottle: "img/perfumes/transparent/Hawas Exotic.webp", set: "img/perfumes/transparent/Hawas Exotic (2).webp" },
  "hawas-ice": { bottle: "img/perfumes/transparent/RASASI - HAWAS ICE.webp", set: "img/perfumes/transparent/RASASI - HAWAS ICE (2).webp" },
  "hawas-fire": { bottle: "img/perfumes/transparent/RASASI - HAWAS FIRE.webp", set: "img/perfumes/transparent/RASASI - HAWAS FIRE (2).webp" },
  "hawas-kobra": { bottle: "img/perfumes/transparent/RASASI - HAWAS KOBRA.webp", set: "img/perfumes/transparent/RASASI - HAWAS KOBRA (2).webp" },
  "hawas-verde": { bottle: "img/perfumes/transparent/Hawas Verde.webp", set: "img/perfumes/transparent/Hawas Verde (2).webp" },
  ...
  // ÁRABE - Otros
  "art-of-universe": { bottle: "img/perfumes/transparent/Art Of Universe.webp", set: "img/perfumes/transparent/Art Of Universe (2).webp" },
  "vulcan-feu": { bottle: "img/perfumes/FRENCH AVENUE - VULCAN FEU.png", set: "img/perfumes/FRENCH AVENUE - VULCAN FEU (2).png" },
  "amber-o-gold-e": { bottle: "img/perfumes/transparent/AL HARAMAIN - AMBER OUD GOLD EDITION.webp", set: "img/perfumes/transparent/AL HARAMAIN - AMBER OUD GOLD EDITION (2).webp" },
  "ao-aqua-dubai": { bottle: "img/perfumes/transparent/Amber Oud Aqua Dubai.webp", set: "img/perfumes/transparent/Amber Oud Aqua Dubai (2).webp" },
  "ao-dubai-night": { bottle: "img/perfumes/transparent/Amber Oud Dubai Night.webp", set: "img/perfumes/transparent/Amber Oud Dubai Night (2).webp" },
  "nitro-red": { bottle: "img/perfumes/transparent/DUMONT PARIS - NITRO RED.webp", set: "img/perfumes/transparent/DUMONT PARIS - NITRO RED (2).webp" },
  "liquid-brun": { bottle: "img/perfumes/transparent/liquid brun.webp", set: "img/perfumes/transparent/liquid brun (2).webp" },
  ...
  "cdn-intense-man": { bottle: "img/perfumes/transparent/ARMAF - CLUB DE NUIT INTENSE EDT.webp", set: "img/perfumes/transparent/ARMAF - CLUB DE NUIT INTENSE EDT (2).webp" },
  "cdn-urban-man-e": { bottle: "img/perfumes/transparent/ARMAF - CLUB DE NUIT URBAN MAN ELIXIR.webp", set: "img/perfumes/transparent/ARMAF - CLUB DE NUIT URBAN MAN ELIXIR (2).webp" },
  "cdn-preciux-i": { bottle: "img/perfumes/transparent/Club de Nuit Precieux I.webp", set: "img/perfumes/transparent/Club de Nuit Precieux I (2).webp" },
  ...
  "bright-peach": { bottle: "img/perfumes/transparent/Bright Peach.webp", set: "img/perfumes/transparent/Bright Peach (2).webp" },
  "paradise-garden": { bottle: "img/perfumes/transparent/Lattafa Paradise Garden.webp", set: "img/perfumes/transparent/Lattafa Paradise Garden (2).webp" },

  // COMBOS
  "combo-cuarteto": { bottle: "img/perfumes/transparent/Cuarteto Oriental Vainilla Freak.webp", set: "img/perfumes/transparent/Cuarteto Oriental Vainilla Freak (2).webp" },
  "combo-vainilla": { bottle: "img/perfumes/transparent/Cuarteto Oriental Vainilla Freak.webp", set: "img/perfumes/transparent/Cuarteto Oriental Vainilla Freak (2).webp" },

  // DESIGNER / NICHO
  "212-edt": { bottle: "img/perfumes/transparent/Carolina Herrera 212 EDT.webp", set: "img/perfumes/transparent/Carolina Herrera 212 EDT (2).webp" },
  "eros-edt": { bottle: "img/perfumes/transparent/Versace Eros EDT.webp", set: "img/perfumes/transparent/Versace Eros EDT (2).webp" },
  "eros-flame": { bottle: "img/perfumes/transparent/VERSACE - EROS FLAME.webp", set: "img/perfumes/transparent/VERSACE - EROS FLAME (2).webp" },
  "spicebomb-extreme": { bottle: "img/perfumes/transparent/Spicebomb Extreme.webp", set: "img/perfumes/transparent/Spicebomb Extreme (2).webp" },
  "azzaro-tmw-edp": { bottle: "img/perfumes/transparent/AZZARO.-AZZARO THE MOSTH WANTED INTENSE EDP.webp", set: "img/perfumes/transparent/AZZARO.-AZZARO THE MOSTH WANTED INTENSE EDP (2).webp" },
  "tmw-parfum": { bottle: "img/perfumes/transparent/AZZARO.-AZZARO THE MOSTH WANTED PARFUM.webp", set: "img/perfumes/transparent/AZZARO.-AZZARO THE MOSTH WANTED PARFUM (2).webp" },
  "swy-intensely": { bottle: "img/perfumes/transparent/EMPORIO ARMANI - STRONGER WITH YOU INTENSELY.webp", set: "img/perfumes/transparent/EMPORIO ARMANI - STRONGER WITH YOU INTENSELY (2).webp" },
  ...
  "ultra-male": { bottle: "img/perfumes/transparent/Jean Paul Gaultier Ultra Male.webp", set: "img/perfumes/transparent/Jean Paul Gaultier Ultra Male (2).webp" },
  "le-male-elixir": { bottle: "img/perfumes/transparent/JEAN PAUL GAULTIER - LE MALE ELIXIR.webp", set: "img/perfumes/transparent/JEAN PAUL GAULTIER - LE MALE ELIXIR EDT.webp" },
  "le-beau-le-parfum": { bottle: "img/perfumes/transparent/JEAN PAUL GAULTIER - LE BEAU LE PARFUM.webp", set: "img/perfumes/transparent/JEAN PAUL GAULTIER - LE BEAU LE PARFUM (2).webp" },
  "victory-elixir": { bottle: "img/perfumes/transparent/Paco Rabanne Victory Elixir.webp", set: "img/perfumes/transparent/Paco Rabanne Victory Elixir (2).webp" },
  "purple-melancholia": { bottle: "img/perfumes/transparent/Purple Melancholia.webp", set: "img/perfumes/transparent/Purple Melancholia (2).webp" },
  "bir-intense": { bottle: "img/perfumes/transparent/Burberry Burberry Brit Intense.webp", set: "img/perfumes/transparent/Burberry Burberry Brit Intense (2).webp" },
  "b-man-in-black": { bottle: "img/perfumes/transparent/Bvlgari Bvlgari Man In Black.webp", set: "img/perfumes/transparent/Bvlgari Bvlgari Man In Black (2).webp" },
  "sauvage-edt": { bottle: "img/perfumes/transparent/Dior Sauvage EDT.webp", set: "img/perfumes/transparent/Dior Sauvage EDT (2).webp" },
  "dylan-blue": { bottle: "img/perfumes/transparent/Versace Dylan Blue.webp", set: "img/perfumes/transparent/Versace Dylan Blue (2).webp" },
  ...
  "1-million-lucky": { bottle: "img/perfumes/transparent/Paco Rabanne 1 Million Lucky.webp", set: "img/perfumes/transparent/Paco Rabanne 1 Million Lucky (2).webp" },
  "invictus-elixir": { bottle: "img/perfumes/transparent/PACO RABANNE -INVICTUS ELIXIR.webp", set: "img/perfumes/transparent/PACO RABANNE -INVICTUS ELIXIR (2).webp" },
  "reserve-privee": { bottle: "img/perfumes/transparent/Armani Reserve Privée.webp", set: "img/perfumes/transparent/Armani Reserve Privée (2).webp" },
  "cedrat-boise-int": { bottle: "img/perfumes/transparent/Mancera Cedrat Boise Intense.webp", set: "img/perfumes/transparent/Mancera Cedrat Boise Intense (2).webp" },
  "m-red-tobacco": { bottle: "img/perfumes/transparent/Mancera Mancera Red Tobacco.webp", set: "img/perfumes/transparent/Mancera Mancera Red Tobacco (2).webp" },
  "by-the-fireplace": { bottle: "img/perfumes/transparent/Maison Margiela By The Fireplace.webp", set: "img/perfumes/transparent/Maison Margiela By The Fireplace (2).webp" },
  "erba-pura": { bottle: "img/perfumes/transparent/Xerjoff Erba Pura.webp", set: "img/perfumes/transparent/Xerjoff Erba Pura (2).webp" },
  "nautica-voyage": { bottle: "img/perfumes/transparent/Nautica Nautica Voyage.webp", set: "img/perfumes/transparent/Nautica Nautica Voyage (2).webp" }
};
