...
export default async function AdminImportPage() {
  ...
  const [qa, orderCounts, pendingCustomers] = await Promise.all([
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}><div><Link className={styles.back} href="/admin">← Administración</Link><h1>Cruzial Import</h1><p>Catálogo, QA de publicación, consolidados, pedidos y clientes.</p></div></header>
      <main>
