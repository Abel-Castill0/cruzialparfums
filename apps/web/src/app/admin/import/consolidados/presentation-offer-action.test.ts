...
beforeEach(()=>{vi.clearAllMocks();mocks.auth.mockResolvedValue({ok:true,membership:{businessUnitId:"import"}});mocks.read.mockResolvedValue({ok:true,data:[item,{...item,importPresentationId:"99003000-0000-4000-8000-000000000004"}]});mocks.write.mockResolvedValue({ok:true,data:{campaign:{updated_at:version},itemCount:2}});});
