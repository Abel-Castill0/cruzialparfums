...
import {
  updatePublicContactSettingAction,
...
export function PublicContactSettingEditor({
  ...
  const boundAction = updatePublicContactSettingAction.bind(null, current.updatedAt);
      ...
      <div className={formStyles.grid} key={current.updatedAt}>
        ...
        <label className={formStyles.fieldFull}>
          ...
          <small id="contactEmail-help" className={styles.help}>
            Correo que ve el público en canales de contacto de Parfums.
          </small>
