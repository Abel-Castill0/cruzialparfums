      ...
      <section className={styles.legal}>
        ...
        <div className={styles.legalBody}>
          ...
          <ul>
            ...
            <li>Los proveedores técnicos que hacen funcionar esta web, descritos en la sección 5.</li>
          </ul>
          ...
          <p><b>Protección contra abuso.</b> Para evitar solicitudes automatizadas o masivas, al registrar una solicitud calculamos una huella irreversible (hash con clave) de tu dirección IP y de tu número; esas huellas se usan únicamente para limitar la frecuencia de solicitudes y no permiten reconstruir el dato original.</p>
